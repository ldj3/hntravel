...
# Database: hntravel
# Generation Time: 2018-05-21 10:37:16 +0000
# ************************************************************
...
VALUES
	(1,'admin','Admin','9d5327f59db8f74f66e99d997edebcaf','cb729c','/assets/img/avatar.png','admin@admin.com',0,1526794589,1492186163,1526794589,'9c3b97cd-fb2b-4dd8-adfa-3c9d59de1075','normal'),
...
VALUES
	...
	(85,'file',0,'example','开发示例管理','fa fa-magic','','',1,1526720606,1526720606,0,'normal'),
	...
	(129,'file',125,'find/strategy','攻略','fa fa-align-justify','','',1,1526795402,1526795429,0,'normal');
...
VALUES
	(4,'banner','banner','/uploads/20180521/cb00f428be66130f4a1dbf0ee8155e58.jpg',NULL,1,NULL,'normal',1526870556,1526870556),
	(6,'三亚游记','三亚游记','/uploads/20180521/26eb28dcddc78ebcfbc7d74d3cbc7b0a.jpg','简介',4,'商城','normal',1526881206,1526886773),
	(7,'一级标题','一级标题','/uploads/20180521/26eb28dcddc78ebcfbc7d74d3cbc7b0a.jpg','简介',5,'问答','normal',1526883680,1526886752);
...
CREATE TABLE `hn_travel_product` (
  ...
  `weigh` int(11) DEFAULT NULL COMMENT '排序',
  `status` int(1) DEFAULT '1' COMMENT '0：不显示，1：显示',
  `createtime` int(11) DEFAULT NULL,
  `updatetime` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
